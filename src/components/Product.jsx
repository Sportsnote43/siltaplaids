...
const features = [
    {
      ...
      imageSrc: 'https://i.imgur.com/lHtd3YH.jpg',
    ...
    },
    {
      ...
      imageSrc: 'https://i.imgur.com/cm4pOn7.jpg',
      ...
      <div className="bg-white">
        <div className="mx-auto max-w-2xl py-24 px-4 sm:px-6 sm:py-32 lg:max-w-7xl lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="text-3xl font-bold tracking-tight text-silta-gray sm:text-4xl">Silta Plaids</h2>
